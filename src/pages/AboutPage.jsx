...
// layout structure of the about page
    return (    
     <div className="app-root"> {/* Wrapper div for the entire page*/}
        ...
        <section className="about-hero"> 
            ...
            <div className="container"> 
                <div className="about-hero__inner"> {/* Inner content wrapper*/}
                     <div className="about-hero__content"> {/* The actual Content area of the hero (intro)section*/}
                        {/* The section Hero title text*/}
                       <div className="about-hero__eyebrow">{hero.eyebrow}</div> 

                       {/*  Main title with "Wizards" highlighted*/}
                        <h1 className="about-hero__title"> {/*Main title with "Wizards" highlighted*/}
                           {hero.title.split("Wizards")[0]} 
                           <span>Wizards</span> 
                           {hero.title.split("Wizards")[1]} 
                        </h1>

                        <p className="about-hero__subtitle">{hero.subtitle}</p>  {/*Subtitle text of our intro About page*/}
                       </div>
                       ...
                       <div className="about-hero__card"> 
                            ...
                            <div className="about-hero__card-title">
                                 Wizards Training
                            </div>
       ...
       <section className="section--story"> 
         <div className="container"> {/* Centered container for content */}
           <div className="story-content"> {/* Actual content area */}
            ...
            <div className="container">
             <div className="section-header"> 
               ...
               <p className="section-header__subtitle">
                 Three pathways for every young wizard’s journey<br />
                 Comprehensive training for all ages and skill levels.
                </p>
             </div>
             <div className="programs-grid"> {/*show the three main program types and their details*/}
               {programs.map((p, idx) => (
        ...
        <section className="section--locations">
          <div className="container">
           <div className="section-header">
            <div className="section-header__eyebrow">Find Us</div>
            <h2 className="section-header__title">Our Training Locations</h2>
            <p className="section-header__subtitle">
             Professional facilities across Lebanon
            </p>
         </div>
         <div className="locations-grid">
            {locations.map((loc, i) => (
              <div key={i} className="location-card">
                 ...
                 <div className="location-card__facility">{loc.facility}</div>
        ...
        <div className="container">
          <div className="mv-grid">
            ...
            <div className="mv-card mv-card--mission"> 
              <div className="mv-card__icon">{missionVision.mission.icon}</div>
              <h3 className="mv-card__title">{missionVision.mission.title}</h3>
...
<section className="section--choose-us">
  <div className="container">
    <div className="section-header">
      ...
      <p className="section-header__subtitle">
        Discover what makes Wizards Football Academy the premier choice for youth development
      </p>
    </div>
